            ...
            <div class="col">
                    ...
                    <form action="../controller/editarNovedad1.php" method="post">
                        ...
                        while ($datos=$sql->fetch_object()){?>
                                    ...
                                    <input type="text"  name="remNovedades" aria-describedby="Remitente" maxlength="6" placeholder="Nombre" value="<?=$datos->remNovedades ?>"><br>
                                    
                                    <!-- Tipo novedad --> 
                                    <label for="tipoNovedad" style="margin-top: 15px; margin-bottom: 10px; font-weight: 700; color:#23518C">Tipo de Novedad</label>
                                    <input type="text" name="TipoNovedad"  aria-describedby="tipoNovedad" value="<?=$datos->TipoNovedad ?>"><br>
                                
                                    <!-- Asunto de Novedad -->

                                    <label for="asuntonovedad" style="margin-top: 15px; margin-bottom: 10px; font-weight: 700; color:#23518C">Asunto Novedad</label>
                                    <input type="text" name="asuntoNovedades" aria-label="Asunto" value="<?=$datos->asuntoNovedades ?>"><br>
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <label for="descripcionNovedad" value="<?=$datos->descNovedades ?>" style="font-size: 13px;">Razon</label><br>
                                    </div>
                                    ...
                                    <input class="form-control" type="file" name="docNovedades" value="<?=$datos->docNovedades ?>"><br>
                                    ...
                                    <input type="date" class="form-control" name="fecNovedades" aria-describedby="fecha_de_Novedad" value="<?=$datos->$fecNovedades ?>"><br>
                

                                    <!-- Respuesta Novedad -->
                                    <label for="respuestanovedad" style="margin-top: 15px; margin-bottom: 10px; font-weight: 700; color:#23518C">Respuesta Novedad</label>
                                    <input type="text" name="resNovedades" aria-label="Asunto1" value="<?=$datos->$resNovedades ?>"><br>
                                    ...
                                    <input type="text" name="estNovedades" aria-label="Asunto" value="<?=$datos->estNovedades ?>"><br>
